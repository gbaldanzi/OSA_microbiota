...
fgsea.module.fun=function(res,outcome,direction)
{
  RANK=NULL
  print(direction)
  for(x in outcome)
...
res.both=fgsea.module.fun(table.res,expos,direction="both")
fwrite(res.both,paste0(output,"ea_modules_both.tsv"),sep = "\t")

res.pos=fgsea.module.fun(table.res,expos,direction="positive")
fwrite(res.pos,paste0(output,"ea_modules_pos.tsv"),sep = "\t")

res.neg=fgsea.module.fun(table.res,expos,direction="negative")
fwrite(res.neg,paste0(output,"ea_modules_neg.tsv"),sep = "\t")
