...
# Function to select the last characters of a string 
 ...
 # Enriched pathways/metabolite groups in the NEGATIVE correlations ####
  ...
  # Legend ####
  col_fun = circlize::colorRamp2(c(0,1.6,3),c("white","indianred2", muted("red3")))
  col_fun2 = circlize::colorRamp2(c(0,1.6,3),c("white","dodgerblue1", muted("blue4")))
  ...
  h1 = Heatmap(t90.odi.cor, 
        ...
        Heatmap(merged.matrix, 
             ...
             col = circlize::colorRamp2(c(-3,-1.6,0,1.6,3),c(muted("blue4"), "dodgerblue1", "white",
