...
# File model 1 - permanova_model1_ahi_ad.tsv
# File model 2 - permanova_model2_ahi_ad.tsv
# File model 3 - permanova_model3_ahi_ad.tsv
...
# Saving result
fwrite(res1, file = paste0(output,"permanova_model1_ahi_ad.tsv"), sep="\t")
fwrite(res2, file = paste0(output,"permanova_model2_ahi_ad.tsv"), sep="\t")
fwrite(res3, file = paste0(output,"permanova_model3_ahi_ad.tsv"), sep="\t")
...
# Saving results 
fwrite(res3.nomed, file = paste0(output,"permanova_model3_nomed_ahi_ad.tsv"), sep="\t")
