...
cd "/home/baldanzi/Sleep_apnea/Results/imp2"

capture log close

log using imputation_ahi_basicmodel_2.txt , replace
set more off
clear 
...
use "/home/baldanzi/Datasets/sleep_SCAPIS/pheno.dta"

foreach mgs of varlist HG3A_0401-HG3A_0800{
...
export delimited using "/home/baldanzi/Sleep_apnea/Results/cor_ahi_imput_mgs_2.tsv", delimit(tab) replace datafmt
