...
cd "/home/baldanzi/Sleep_apnea/Results/imp4"

capture log close

log using imputation_ahi_basicmodel_4.txt , replace
set more off
clear 
...
foreach mgs of varlist HG3A_1201-HG3A_1980{
...
export delimited using "/home/baldanzi/Sleep_apnea/Results/cor_ahi_imput_mgs_4.tsv", delim(tab) replace datafmt
