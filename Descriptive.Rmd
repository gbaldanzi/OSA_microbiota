...
**Partial Spearman Correlation between AHI and Shannon**
...
4. Model 3_noMedication = removed individuals using PPI, Metformin and self-reported use of anti-hypertension and cholesterol-lowering medication 
...
**Partial Spearman Correlation between T90% and Shannon**
