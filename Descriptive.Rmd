...
mylabel <- c("OSA severity", "Age (yrs)", "Sex", "Smoking status", "Alcohol intake (g)", 
             ...
             "%time Sat=<90%", "CPAP", "Oral appliance")
...
t = compareGroups(OSAcat ~ age + Sex + smokestatus + Alkohol + BMI + educat +
                  ...
                  hypermed + dyslipmed+Fibrer+ ahi+ odi+ sat90+ cpap+ splint, data= datatable1, 
...
knitr::kable(shannoncor, caption = "Correlation between Shannon diversity and AHI", 
  ...
  kable_styling()
```
1. Model 1 = sex, age, BMI, smoking, alcohol, plate, received 
2. Model 2 = + PA, education, place birth, fiber intake, ppi
3. Model 3 = + diabetes, hypertension, dyslipidemia, self-reported medication 
