...
## T90 
_% of time with oxygen saturation below 90%_     
...
`r n1` have valid T90 measurement      
...
t = compareGroups(OSAcat ~ age + Sex + smokestatus + Alkohol + BMI + educat +
                  ...
                  hypermed + dyslipmed+ ppi+Fibrer+ ahi+ odi+ sat90+ ESS+ cpap+ splint, data= datatable1, 
...
#### Smoking based on metabolome {.tabset}
...
## Taxa abundance by Sleep apnea severity {.tabset} 
...
<br>
<br>
```{r corrshannon, echo=FALSE, message=FALSE, warning=FALSE,fig.align='center'}
...
knitr::kable(shannoncor, caption = "Correlation between Shannon diversity and AHI", 
  ...
  kable_styling()
```
1. Model 1 = sex, age, smoking, alcohol, plate, received 
2. Model 2 = + BMI, PA, education, place birth, fiber intake
3. Model 3 = + diabetes, hypertension, dyslipidemia, ppi, self-reported medication 
