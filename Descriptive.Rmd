...
name = names(shannoncor)[names(shannoncor)!=covariates]
shannoncor = shannoncor[,name,with=F]
setnames(shannoncor, "MGS", "Var 1")
setnames(shannoncor, "exposure", "Var 2")
shannoncor[,cor.coeficient:=round(cor.coeficient,3)]
shannoncor[3:4,p.value:=round(p.value,digits = 3)]
shannoncor[1:2,p.value:=formatC(p.value,digits = 2, format ="e")]
