...
2. Model 2 = + BMI 
3. Model 3 = + PA + education + place birth + fiber intake + energy intake + medication   
(PPI + metformin + antihypertensive + cholesterol-lowering)
  
5. Sensitivity Analysis = removed medication users 
...
1. Model 1 = sex + age + smoking + alcohol + plate 
2. Model 2 = + BMI 
3. Model 3 = + PA + education + place birth + fiber intake + energy intake + medications   
(PPI + metformin + antihypertensive + cholesterol-lowerring)
  
4. Sensitiviy analysis = removed medication users 
...
n4 = perma_OSA_BC4[variables =="OSAcat", 'Pr(>F)']
...
perma_AHI_BC4= fread('/home/baldanzi/Sleep_apnea/Results/permanova_model4_ahi_bc.tsv')
perma_AHI_BCsa= fread('/home/baldanzi/Sleep_apnea/Results/permanova_model3_nomed.tsv')

x1 = perma_AHI_BC1[variables =="ahi", 'Pr(>F)']
x2 = perma_AHI_BC2[variables =="ahi", 'Pr(>F)']
x3 = perma_AHI_BC3[variables =="ahi", 'Pr(>F)']
x4 = perma_AHI_BC4[variables =="ahi", 'Pr(>F)']
...
knitr::kable(perma_OSA_BCsa, caption = "OSA and BC - model 3 no medication") %>% kable_styling()
```
...
```{r permanovaAHI4, }
perma_AHI_BC4 = fread('/home/baldanzi/Sleep_apnea/Results/permanova_model4_ahi_bc.tsv')
perma_AHI_BC4 = apply(perma_AHI_BC4,2,function(x){ifelse(!is.na(x),x,"")})
knitr::kable(perma_AHI_BC4, caption = "AHI and BC - model 4") %>% kable_styling()
```
<br>
...
knitr::kable(perma_AHI_BCsa, caption = "AHI and BC - model 3 no medication") %>% kable_styling()
```
<br>
...
4. Model 4 = + PPI + metformin + antihypertensive + cholesterol-lowering 
  
5. SA = removed medication users 
...
model2 = + PA + fiber + energy intake + place of birth + education 
