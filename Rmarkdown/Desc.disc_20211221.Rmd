...
**`r mgs.fdr.m2_n`** MGS were correlated with AHI, ODI or T90, but not with BMI
...
## AHI {-}
```{r,echo =FALSE, message=FALSE, warning=FALSE, fig.align='center', out.width="70%", out.height="70%"}
datatable(list.res$ahi) %>% formatStyle(c(1,3,5,7), `border-right` = "solid 2px")
```
***
...
## T90 {-}
```{r,echo =FALSE, message=FALSE, warning=FALSE, fig.align='center', out.width="70%", out.height="70%"}
datatable(list.res$t90) %>% formatStyle(c(1,3,5,7), `border-right` = "solid 2px")
```
***
...
## ODI {-}
```{r,echo =FALSE, message=FALSE, warning=FALSE, fig.align='center', out.width="70%", out.height="70%"}
datatable(list.res$odi) %>% formatStyle(c(1,3,5,7), `border-right` = "solid 2px")
```
***
