...
# correlated to AHI, T90 and BMI
  ...
  #Saving 
  save(res.both,file=paste0(output,"ea_family_table_both.rds"))
  save(res.pos,file=paste0(output,"ea_family_table_pos.rds"))
  save(res.neg,file=paste0(output,"ea_family_table_neg.rds"))