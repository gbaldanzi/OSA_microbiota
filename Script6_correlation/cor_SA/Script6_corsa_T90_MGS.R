...
# Results saved at "/home/baldanzi/Sleep_apnea/Results/corsa_t90_mgs.tsv"
...
valid.t90 <-  valid.t90[ppi == "no",] #60
valid.t90 <-  valid.t90[metformin == "no",] #57 
valid.t90 <-  valid.t90[hypermed == "no",] #593
valid.t90 <-  valid.t90[dyslipmed == "no",] # 239
...
fwrite(res, file = paste0(output,"corsa_t90_mgs.tsv"), sep="\t")
...
dades <- fread(paste0(output,"corsa_t90_mgs.tsv"))
dades <- merge(dades, taxonomy, by="MGS", all.x=T)
fwrite(dades, file=paste0(output,"corsa_t90_mgs.tsv"))