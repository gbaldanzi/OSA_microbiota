...
for(m in mgs.ahi){
  ...
  cat("  \n")
  cat(paste0("![](qr_ahi/plots_qr_ahi_",m,".png)"))
  cat("  \n")
}
...
for(m in mgs.t90){
  ...
  cat("  \n")
  cat(paste0("![](qr_t90/plots_qr_t90_",m,".png)"))
  cat("  \n")
}
...
all.pheno=fread("/home/baldanzi/Datasets/sleep_SCAPIS/SCAPIS-DATA-PETITION-170-20210315.csv", header = T, na.strings=c("", "NA"))
  ...
  # Self reported sleep apnea variable 
  all.pheno[cqhe058=="NO_ANSWER", cqhe058:=NA]
...
**`r n`** participants self-reported having a doctor diagnosis of sleep apnea 
